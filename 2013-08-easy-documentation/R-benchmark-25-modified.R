r25 <- function() {
  ...
  ## =============================================================================
  ## Modification 1: Additional matrix to store benchmark results
  ## =============================================================================
  
  all.timing <- matrix(1, nrow=17, ncol=3)
  all.timing[1:5, 1] <- "Matirx calculation"
  all.timing[6:10, 1] <- "Matirx functions"
  all.timing[11:15, 1] <- "Programmation"
  all.timing[16:17, 1] <- "Summary"
  
  
  ## =============================================================================
  ## Original R-benchmark-25 codes
  ## =============================================================================
  ...
  times[1, 1] <- timing
  ## =============================================================================
  ## Modification - storing results
  all.timing[1,2] <- "Creation, transp., deformation of a 2500x2500 matrix"
  all.timing[1,3] <- timing
  ## =============================================================================
  ...
  ## =============================================================================
  ## Modification - storing results
  all.timing[2,2] <- "2400x2400 normal distributed random matrix ^1000"
  all.timing[2,3] <- timing
  ## =============================================================================
  ...
  ## =============================================================================
  ## Modification - storing results
  all.timing[3,2] <- "Sorting of 7,000,000 random values"
  all.timing[3,3] <- timing
  ## =============================================================================
  ...
  ## =============================================================================
  ## Modification - storing results
  all.timing[4,2] <- "2800x2800 cross-product matrix (b = a' * a)"
  all.timing[4,3] <- timing
  ## =============================================================================
  ...
  ## =============================================================================
  ## Modification - storing results
  all.timing[5,2] <- "Linear regr. over a 3000x3000 matrix (c = a \\ b')"
  all.timing[5,3] <- timing
  ## =============================================================================
  ...
  ## =============================================================================
  ## Modification - storing results
  all.timing[6,2] <- "FFT over 2,400,000 random values"
  all.timing[6,3] <- timing
  ## =============================================================================
  ...
  ## =============================================================================
  ## Modification - storing results
  all.timing[7,2] <- "Eigenvalues of a 640x640 random matrix"
  all.timing[7,3] <- timing
  ## =============================================================================
  ...
  ## =============================================================================
  ## Modification - storing results
  all.timing[8,2] <- "Determinant of a 2500x2500 random matrix"
  all.timing[8,3] <- timing
  ## =============================================================================
  ...
  ## =============================================================================
  ## Modification - storing results
  all.timing[9,2] <- "Cholesky decomposition of a 3000x3000 matrix"
  all.timing[9,3] <- timing
  ## =============================================================================
  ...
  ## =============================================================================
  ## Modification - storing results
  all.timing[10,2] <- "Inverse of a 1600x1600 random matrix"
  all.timing[10,3] <- timing
  ## =============================================================================
  ...
  ## =============================================================================
  ## Modification - storing results
  all.timing[11,2] <- "3,500,000 Fibonacci numbers calculation (vector calc)(sec)"
  all.timing[11,3] <- timing
  ## =============================================================================
  ...
  ## =============================================================================
  ## Modification - storing results
  all.timing[12,2] <- "Creation of a 3000x3000 Hilbert matrix (matrix calc) (sec)"
  all.timing[12,3] <- timing
  ## =============================================================================
  ...
  ## =============================================================================
  ## Modification - storing results
  all.timing[13,2] <- "Grand common divisors of 400,000 pairs (recursion)"
  all.timing[13,3] <- timing
  ## =============================================================================
  ...
  ## =============================================================================
  ## Modification - storing results
  all.timing[14,2] <- "Grand common divisors of 400,000 pairs (recursion)"
  all.timing[14,3] <- timing
  ## =============================================================================
  cat(c("Grand common divisors of 400,000 pairs (recursion)_______ (sec): ", timing, "\n"))
  remove("b", "j", "k")
  if (R.Version()$os == "Win32" || R.Version()$os == "mingw32") flush.console()
  ...
  ## =============================================================================
  ## Modification - storing results
  all.timing[15,2] <- "Escoufier's method on a 45x45 matrix (mixed)"
  all.timing[15,3] <- timing
  ## =============================================================================
  ...
  ## =============================================================================
  ## Modification - summarising results
  all.timing[16,2] <- "Total time for all 15 tests"
  all.timing[16,3] <- sum(as.numeric(all.timing[1:15,3]))
  all.timing[17,2] <- "Overall mean (note: not trimmed means)"
  all.timing[17,3] <- mean(as.numeric(all.timing[1:15,3]))
  df.timing <- data.frame(Group = all.timing[,1],
                          Test = all.timing[,2],
                          Duration = as.numeric(all.timing[,3]))
  return(df.timing)
  ## =============================================================================
